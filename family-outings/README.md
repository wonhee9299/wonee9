...
- **[가을 주말 빈집털이 나들이 — 하남 기준](./fall-weekend-empty.md)** (2판) — 정원제·예약제로 인원 상한이 걸린 곳만 골라 순위화. **미사역 기준 실측 도로거리**, 4인 비용, 도시락·돗자리·텐트 규정, **한강공원 과태료표**, 모래놀이 특화(광나루 모두의놀이터·보라매 풍경놀이터), 뺀 곳과 근거, **재조사 로그(내 오류 3건 정정)**
