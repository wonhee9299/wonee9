...
| 항목 | 값 |
|---|---|
| 가족 | 아빠 · 엄마 · **첫째 8세(130cm)** · **둘째 3세 후반(101cm)** |
| 기준지 | **하남 미사** |
| **차** | **전기차** — 주차·충전 판단에 영향(급속 1시간 / 완속 14시간 규정, 충전기 위치) |

> 차 정보는 2026-09-21에 추가했다. 그전 문서들은 차종을 모른 채 주차를 계획했다 — 경위는 [AUDIT ⑱](./AUDIT-2026-09-07.md).
...
- **[레고랜드 코리아 가성비 공략 가이드](./legoland-guide.md)** — 평일/주말 전략·드래곤 코스터·체험형/놀이터·영화 시간표·주차&셔틀 6축. **2026-09-23 실제 방문으로 검증됨.**
  [PDF](./assets/legoland_20260923_plan.pdf) · [PPT(15장, 방문 결과 검증 슬라이드 포함)](./assets/legoland_20260923_plan.pptx)
  - 드래곤 포함 9종 상세 + 40종 신장조건 요약 · 체험형·놀이터 총정리 · 패스트트랙/대여 여부 판단 기준 · 실제 방문 결과 4건 검증(대기시간·영화시간표·비용·동선)
  - 원자료: [park-legoland.md](./park-legoland.md)
...
- **[코엑스 아쿠아리움 — 주차부터 짜는 계획](./coex-aquarium.md)** (8판) — **코엑스 북문 GATE → B2 블루존 52G~60G**(→B1 한 층), 4시간 **4,800원** 할인 등록법, 옥상 주차장 425면 실측 계수, **전기차 급속 1시간 규정** 반영, GBB·VR 1회 1개, 인어·물범·가오리 **공연 3종** 기준 A/B/C/C+ 4안 + [작전카드 PDF](./assets/coex_aquarium_plan.pdf)
- [하남 기준 가성비 캠핑장 목록](./camping-near-hanam.md) — 당일치기/1박, 거리순, 4인 1박 예상 요금, 예약 오픈일, **텐트 설치형(장비 없이 가는 곳) 별도 표**
- **[레고랜드 코리아 — 원자료](./park-legoland.md)** — 어트랙션 40개 전수 신장·나이 조건, 체험형·놀이터 총정리, 주차장 전략(도보 vs 셔틀), 동선 지도 검증, 주말/평일 스케줄 전략, 9/23 실제 방문 예시 일정, 주의점 체크리스트, 조사 과정과 출처 등급까지 전부. **공유용 정리본은 [레고랜드 코리아 가성비 공략 가이드](./legoland-guide.md) 참고.**
