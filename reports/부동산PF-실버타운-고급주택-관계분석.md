...
- 실버타운(노인복지주택)은 임대형만 가능해 분양대금으로 공사비를 회수할 수 없다. 그래서 PF 의존도가 높고, 대주단은 건설사 신용보강을 요구한다. 중소 시행사가 진입하기 어려운 구조적 이유다.
...
- `[추론]` 고급주택은 분양이 끝나면 시행사 리스크가 종료되지만, 실버타운은 보증금이라는 부채를 운영사가 계속 안고 간다. 이 차이 때문에 실버타운은 "누가 짓느냐"보다 "누가 운영하고 보증금을 어떻게 보호하느냐"가 사업성의 핵심이 된다.
